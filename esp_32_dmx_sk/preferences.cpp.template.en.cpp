...
// SECTION SETUP
// Default DMX Address of the first channel (1 indexed) (If you want to change the Address In-Field you can use any value here)
#define DMX_START_ADDRESS 1
// Allow to change the Address? 1 Allows changing via a DMX procedure, 2 Allows changing it using two buttons, 3 Allows changing it using a DIP Switch Array (see Manual for Descriptions)
